// 將 concussion-media-articles 的 2 篇 .md 轉成「Media（大眾衛教）」風格 HTML
// 沿用 build-ins-media.js 的 markdown 轉換器與 Media 版型（teal 品牌）
const fs = require('fs');
...
function seriesBox(items, activeIdx){
  ...
  return `  <div class="series-box">
    <div class="sb-h">腦震盪系列 · 2026 世界盃特輯</div>
${links}
  </div>`;
}
...
<main>
  <span class="article-tag">腦震盪 · 運動傷害</span>
  <h1>${esc(a.title)}</h1>
...
console.log('完成：', parsed.length, '篇 Media 腦震盪文章');
