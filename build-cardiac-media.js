// 將 summer-cardiac-media-articles 的單篇 .md 轉成「Media（大眾衛教）」風格 HTML
...
const article = {
  ...
  out: 'summer-cardiac-brain.html',
  title: '',
  desc: '夏至清晨一位董事晨運猝倒，最近的 AED 卻在幾百公尺外。心臟停下的那一刻，最先倒數的其實是大腦——談 CPR 為什麼是替腦續氧、AED 為什麼是那記真正的開機鍵。',
  tag: '猝倒急救 · 夏季健康',
};

// 相關閱讀（皆在 posts/ 同層）
const related = [
  { out: 'summer-cardiac-brain.html', nav: '本篇', title: '夏至晨運他倒下了——最先死去的其實是大腦' },
...
function seriesBox(items, activeIdx){
  ...
  return `  <div class="series-box">
    <div class="sb-h">急救與腦保護 · 相關閱讀</div>
${links}
  </div>`;
}
...
console.log('完成：1 篇 Media 夏季猝倒急救文章');
