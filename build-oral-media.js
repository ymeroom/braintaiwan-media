// 將 oral-brain-media-articles 的單篇 .md 轉成「Media（大眾衛教）」風格 HTML
// 沿用 build-concussion-media.js 的 markdown 轉換器與 Media 版型（teal 品牌）
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/oral-brain-media-articles';
const OUT = path.join(__dirname, 'posts');
const SITE = 'https://media.braintaiwan.com';
const DATE = '2026 年 6 月';

const article = {
  md: 'oral-brain-dementia.md',
  out: 'oral-brain-dementia.html',
  title: '',
  desc: '嘴哥一句「真冰涼」紅遍全台——熱魚羹接冰紅茶為什麼這麼爽？神經科從 TRP 溫度受體的「感覺對比」一路講到一件少有人連起來的事：缺牙、咀嚼變差，竟和幾十年後的失智風險有關。',
  tag: '感覺神經 · 大腦保養',
};

// 相關閱讀（皆在 posts/ 同層）
const related = [
  { out: 'oral-brain-dementia.html', nav: '本篇', title: '嘴哥一句「真冰涼」，藏著大腦最在意的一件事' },
  { out: 'iron-fist-brain.html',     nav: '大腦', title: '多巴胺與獎賞：大腦為什麼追著「爽」跑' },
  { out: 'concussion-what-is.html',  nav: '腦傷', title: '頭撞一下，大腦裡發生了什麼？' },
];
...
function seriesBox(items, activeIdx){
  ...
  return `  <div class="series-box">
    <div class="sb-h">大腦這樣運作 · 相關閱讀</div>
${links}
  </div>`;
}
...
console.log('完成：1 篇 Media 缺牙與大腦文章');
