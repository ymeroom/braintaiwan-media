// 將 dementia-articles 的 5 篇 .md 轉成「Media（大眾衛教）」風格 HTML
// 由 MD 站搬遷而來：沿用 braintaiwan-md/build-dem.js 的 markdown 轉換器，僅替換版型為 Media 風格
// 輸出至 braintaiwan-media/posts/，並自帶 TL;DR 無、分享列、作者框、系列導覽
const fs = require('fs');
...
// ───────── markdown 轉換器（與 build-dem.js 相同）─────────
...
function seriesBox(items, activeIdx){
  ...
  return `  <div class="series-box">
    <div class="sb-h">失智症衛教系列 · 從一則新聞談起</div>
${links}
  </div>`;
}
...
console.log('完成：', parsed.length, '篇 Media 失智症文章');
